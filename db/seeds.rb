...
Toilet.create(name: "Beautiful restaurated Toilet", air_con: true, available: true, wifi: true, description: "We can give you slippers", address:"Rua de São Bento 2, Lisbon", remote_photo_url: "https://static.boredpanda.com/blog/wp-content/uploads/2016/02/amazing-toilet-views-around-the-world-7__880.jpg", owner: User.all.sample)
Toilet.create(name: "Toilet clean af", floor_heating: true, air_con: true, speakers: true, description: "Only without shoes", address:"R. Nova da Piedade 10, 1200-192 Lisboa", remote_photo_url: "https://static.boredpanda.com/blog/wp-content/uploads/2016/02/amazing-toilet-views-around-the-world-91__880.jpg", owner: User.all.sample)
...
Toilet.create(name: "Je pisse donc je suis", air_con: true, available: true, window: true, description: "Smells like flowers, even after your conference. Installed Venus breeze right next to toilet. Also the bible is in a cupboard next to toilet (put bible on the right of toilet, in case you need further help from higher powers", reading_material: true, address:"Av. de Berna 45A, 1067-001 Lisboa", remote_photo_url: "https://i.pinimg.com/originals/8d/c6/bc/8dc6bc8ab8a0476d7cdc81fa2b48ee1f.jpg", owner: User.all.sample)
Toilet.create(name: "Klo der Weisen", description: "I have so many books in my bathroom you don't want to stand up anymore. If you do, take care, the ceiling is not so high.", reading_material: true, address:"Av. Eng. Duarte Pacheco, 1000-000 Lisboa", remote_photo_url: "https://i.pinimg.com/736x/3a/67/80/3a67804b3f4d19e134cadbf535ad0e74.jpg", owner: User.all.sample)
...
Toilet.create(name: "TV installedFresh towels for free", floor_heating: true, available: true, description: "No smoking please. But you have a TV in bathroom", address:"Largo Ajuda 1349-021, Lisboa", remote_photo_url: "https://d.justpo.st/media/images/2016/03/02/best-bathroom-ever-tv-screen-in-floor-below-toilet-1456896622.jpg", owner: User.all.sample)
