...
Toilet.create(name: "Toilet clean af", available: true, floor_heating: true, air_con: true, speakers: true, description: "Only without shoes", address:"Rua do Conde de Redondo 27", remote_photo_url: "https://static.boredpanda.com/blog/wp-content/uploads/2016/02/amazing-toilet-views-around-the-world-91__880.jpg", owner: User.all.sample)
...
Toilet.create(name: "Toilet not so clean", available: true, floor_heating: true, description: "Not longer than 5 min pls. My younger brother has stomach illness. You too after using it, didn't clean since Bowie died", address:"Rua do Conde de Redondo 5, Santo António, Área Metropolitana de Lisboa, Portugal", remote_photo_url: "https://previews.123rf.com/images/neagonefo/neagonefo1709/neagonefo170900127/86894394-dirty-old-toilets-bowl-and-the-bathrooms-is-not-very-clean.jpg", owner: User.all.sample)
...
Toilet.create(name: "Smoking allowed. ", available: true,  speakers: true, window: true, description: "You may smoke. The carpet will remind you of an Indian empire", reading_material: true, address:"Rua do Conde de Redondo 60", remote_photo_url: "https://previews.123rf.com/images/svproduction/svproduction1709/svproduction170900225/87105766-white-toilet-bowl-close-up-on-the-carpet-in-the-center-of-the-room-as-an-abstraction-.jpg", owner: User.all.sample)
puts "Toilets done!"
