...
Toilet.create(price: 2, name: "Smoking allowed. ", available: true,  speakers: true, window: true, description: "You may smoke. The carpet will remind you of an Indian empire", reading_material: true, address:"Rua do Conde de Redondo 60", remote_photo_url: "https://previews.123rf.com/images/svproduction/svproduction1709/svproduction170900225/87105766-white-toilet-bowl-close-up-on-the-carpet-in-the-center-of-the-room-as-an-abstraction-.jpg", owner: User.all.sample)
puts "Toilets done!"
